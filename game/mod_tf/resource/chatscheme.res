...
Scheme
{
	...
	BaseSettings
	{
		...
		Button.ArmedBgColor				"Blank"				[$WIN32_old]
		...
		Frame.BgColor					"160 160 160 128"	[$WIN32_old]
		Frame.BgColor					"80 80 80 192"		[$WIN32]
		Frame.OutOfFocusBgColor			"160 160 160 32"	[$WIN32_old]
		...
		FrameTitleBar.Font				"UiBold"		[$WIN32_old]
		FrameTitleBar.Font				"DefaultLarge"	[$WIN32_old]
		...
		MainMenu.TextColor			"White"				[$WIN32_old]
		MainMenu.TextColor			"200 200 200 255"	[$WIN32]
		MainMenu.ArmedTextColor		"200 200 200 255"	[$WIN32_old]
		MainMenu.ArmedTextColor		"White"				[$WIN32]
		MainMenu.DepressedTextColor	"192 186 80 255"
		MainMenu.MenuItemHeight		"16"	[$WIN32_old]
		...
		NewGame.SelectionColor		"Orange"	[$WIN32_old]
