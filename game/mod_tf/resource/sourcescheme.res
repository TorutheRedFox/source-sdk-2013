...
Scheme
{
	...
	BaseSettings
	{
		...
		MainMenu.TextColor			"TanLight"			[$WIN32_old]
		MainMenu.ArmedTextColor		"117 107 94 255"	[$WIN32_old]
		MainMenu.Inset				"32"
	...
	Fonts
	{
		...
		AchievementItemTitle	[$WIN32_old]
		{
			"1"
			{
				"name"		"Arial" [!$OSX]
		...
		AchievementItemTitleLarge	[$WIN32_old]
		{
			"1"
			{
				"name"		"Arial" [!$OSX]
		...
		AchievementItemDescription	[$WIN32_old]
		{
			"1"
			{
				"name"		"Arial" [!$OSX]
